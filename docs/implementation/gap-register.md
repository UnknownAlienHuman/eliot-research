...
| P1 | Owner structural Corpus Lens is active end to end: N1 honest structural SourceCard/DocumentMap materialization runs in the supported orientation path from admitted R2 bundles through the pure materializer into immutable D1 persistence with explicit gaps and fail-closed integrity; N2/N3/N4 Atlas and source-span evidence navigation remain incomplete | ER-06, ER-07, ER-24, ER-31, ER-39 | complete exact source-span/Atlas paths, full query retrieval and retained remote receipts; see `local-launch.md` |
