...
| P1 | W2 monotone bounded executor and executable ResearchWorkflow binding run over D1/R2 with restart resume, single-effect replay and 64KiB handle-only steps; governed model/evidence stages, branch scheduler and notification/retention/restore composition remain incomplete | ER-09, ER-10, ER-13, ER-16, ER-24 | W2 local real-storage monotone/restart/duplicate/cancel/lost-ACK/binding fixtures; complete W3 settlement, W4 evidence/audit, branch scheduler and runtime closures before live qualification; see `workflow-checkpoints.md` |
