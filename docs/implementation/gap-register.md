...
| P1 | ScopeSnapshot D1 persistence and freezer/evidence identity compatibility are implemented; production atom/policy authority, principal grants, retrieval composition and live qualification remain open | ER-10, ER-24, ER-30 | local D1 freeze/readback, exact replay, lost-ACK and invalidation tests exist; compose current authority/grants/retrieval and retain deployed purge, deny and expiry receipts |
| P1 | Corpus Lens immutable D1 persistence and scoped service composition are implemented locally; public `research.orient`, automatic materialization and live qualification remain open | ER-06, ER-07, ER-24, ER-31, ER-39 | compose production ScopeSnapshot/current policy and grant issuance, materialization and QueryResult trace/evidence outputs; retain remote Atlas→section→resolved EvidenceHandle receipts |
