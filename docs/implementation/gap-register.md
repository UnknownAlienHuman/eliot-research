...
The deployed release is main `8b418fe` (Cloudflare version
`7ee92390-e3c7-4fb2-9e0b-54a7bccf1cf6`). Its Recent work view shows the latest 20
...
| P1 | Owner REPORT admission, semantic audit, saved DRAFT bytes and claim-to-citation readback have bounded live evidence. Wiki proposals can be created from research, manually reviewed, published and reopened; accepted artifact publication, copy-on-write updates and dependency invalidation remain open. Artifact-draft, research-completed and Wiki-publication change producers are atomic in migrations `0060`–`0062`, while source admitted/updated/erasure producers and the remaining feed scope remain open. | ER-11, ER-12, ER-21, ER-24 | Retain the actual report/audit/citation and owner Wiki publication receipts in `live-document-project-acceptance-2026-09-14.md`. Manual Wiki publication now admits server-owned review with currentness checked in the head-CAS transaction; complete accepted report semantics and the update/purge/change lifecycle. |
