...
| P1 | Mandatory Day-0 ChatGPT Drive Exchange is incomplete: bounded Sheet/changes REST and contribution guards exist; OAuth, durable cursor/reconciler, Docs/export/publication and runtime composition remain missing. Optional Gemini MCP does not replace it | ER-18, ER-19, ER-20, ER-24, ER-26 | implement narrow OAuth, atomic append, leased cursor, R2 freeze/D1 reconciliation, historical tamper audit and result delivery/readback; real account qualification follows complete local code; `drive-rest.md`, `canonical-alignment.md` |
