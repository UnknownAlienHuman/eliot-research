...
| P2 | Local preparation builds PWA and migrates both D1 stores; interactive local Access session/bootstrap still needs completion | ER-00, ER-26 | clean owner session with explicit read-policy provisioning, no auth bypass; `local-launch.md` |
