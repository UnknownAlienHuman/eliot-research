...
| P2 | PWA has authorized Library-to-Lens and same-tab normalized-bundle import/resume/status; cross-session recovery, revision/readiness views and the full setup-to-import browser loop remain incomplete | ER-25 | browser session/reconnect and full owner-loop tests with degraded dependencies |
