...
| P1 | Owner metadata Corpus Lens is active end to end; N1 honest structural SourceCard/DocumentMap materialization from exact admitted bytes is implemented and immutably persisted with explicit gaps; N2/N3/N4 Atlas and source-span evidence navigation remain incomplete | ER-06, ER-07, ER-24, ER-31, ER-39 | complete exact source-span/Atlas paths, full query retrieval and retained remote receipts; see `local-launch.md` |
