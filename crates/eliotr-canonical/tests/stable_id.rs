use eliotr_canonical::{
    ...
    STABLE_ID_LENGTH_CODE, STABLE_ID_MAX_PARTS, STABLE_ID_NUL_CODE, STABLE_ID_PART_MAX_BYTES,
    STABLE_ID_PART_TOO_LARGE_CODE, STABLE_ID_PREFIX_CODE, STABLE_ID_PREFIX_MAX_BYTES,
    STABLE_ID_PREFIX_TOO_LARGE_CODE, STABLE_ID_TOO_MANY_PARTS_CODE, STABLE_ID_UTF8_CODE,
    StableIdError, derive_stable_id, derive_stable_id_frame, validate_stable_id,
};
