...
async function readVerifiedNormalizedBundle(
  ...
  if (manifestObject.sha256 !== receipt.manifest_sha256) {
    structuralFail("NAVIGATION_SOURCE_MISMATCH", "admitted manifest bytes differ from the durable receipt digest");
  }
