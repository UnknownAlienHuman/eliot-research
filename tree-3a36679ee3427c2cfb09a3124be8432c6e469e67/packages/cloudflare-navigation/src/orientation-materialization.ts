...
import { bufferBounded, canonicalDigest, canonicalNormalizedBundleKey, createR2EvidenceObjectStore, objectResidencyKeyDigest, residencyKeyForManifest, type EvidenceObjectStore } from "@eliotr/platform-cloudflare";
