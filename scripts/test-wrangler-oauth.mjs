...
await check("config location supports verified Windows default and profiles", () => {
  ...
  assert.ok(windows[0].endsWith("xdg.config\\.wrangler\\config\\default.toml"));
  assert.ok(windows[1].endsWith(".wrangler\\config\\default.toml"));
  ...
  assert.ok(named[0].endsWith("xdg.config\\.wrangler\\config\\work.toml"));
  ...
  assert.equal(windowsXdg[0], "D:\\xdg\\.wrangler\\config\\default.toml");
