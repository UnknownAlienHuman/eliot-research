...
| P1 | W2a durable stage checkpoints execute over D1/R2; public Research Workflow, governed model/evidence stages, branch scheduler and notification/retention/restore composition remain incomplete | ER-09, ER-10, ER-13, ER-16, ER-24 | W2a local real-storage replay/rollback/bounds fixtures; complete W3 settlement, W4 evidence/audit, W2 scheduler and runtime closures before live qualification; see `workflow-checkpoints.md` |
