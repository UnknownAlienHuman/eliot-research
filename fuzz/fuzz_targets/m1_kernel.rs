...
use eliotr_canonical::{
    canonicalize_json, sha256, validate_canonical_utf8_transport, validate_generation_token,
};
use eliotr_test_vectors::{parse_canonical_body_vector_set, parse_vector_set};
