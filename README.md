...
**A private owner workspace is deployed** behind Cloudflare Access; its address, account and model
selection are operator configuration and are intentionally not published in this repository.
