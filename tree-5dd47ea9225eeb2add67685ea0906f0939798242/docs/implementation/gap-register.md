...
| P2 | PWA Corpus Lens now uses the real orientation/trace API with cancellation, typed errors and no private offline cache; investigation, evidence/Wiki/report loops remain incomplete | ER-25 | browser session/reconnect and full owner-loop tests with degraded dependencies |
