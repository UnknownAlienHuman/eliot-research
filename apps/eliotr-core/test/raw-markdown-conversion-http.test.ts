...
function conversionRequest(captureId: string, idempotencyKey = "markdown-convert-1", signal?: AbortSignal): Request { return new Request(`https://research.example/api/v1/ingest/raw/${captureId}/markdown`, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ idempotency_key: idempotencyKey, max_output_bytes: 1_000, max_tokens: 100, timeout_ms: 1_000 }), signal }); }
