      ...
      if (lane === "exploratory") {
        ...
        handlers = createResearchExploratoryStageHandlers({
          ...
          ...(handlerGeneration === SERVER_OWNED_RETRIEVAL_HANDLER_GENERATION ? {
            retrieval: { database: db, search_database: env.SEARCH_DB, work_bucket: bucket, evidence_bucket: env.EVIDENCE_BUCKET, access },
          } : {}),
        });
      } else {
