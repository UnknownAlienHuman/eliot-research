...
export function assertRetrievalSelection(view: RetrievalResultView, sourceRevisionRef: string): void {
  if (view.evidence.some((item) => item.handle.source_revision_ref !== sourceRevisionRef)) {
