...
export const AI_SEARCH_PRIMARY_GENERATION =
  "g2-qwen3-2026-09-03" as const;
export const AI_SEARCH_PRIMARY_INSTANCE_ID = "private-prose-g2" as const;

/**
 * Managed profile used by governed source projection. Provider create-only
 * fields remain enforced by the provisioning compiler and desired-state gate.
 */
export const AI_SEARCH_PRIMARY_PROJECTION_PROFILE: AiSearchInstanceProfile =
  Object.freeze({
