...
export const ROUTES: readonly RouteDefinition[] = [
  ...
  { method: "GET", path: "/api/v1/research/artifact/:ref/sections/:section_ref", operation: "research.artifact.section", auth: "owner_or_service", maximum_request_bytes: 0, response_mode: "stream" },
  { method: "GET", path: "/api/v1/research/artifact/:ref/sections/:section_ref/citations", operation: "research.artifact.section.citations", auth: "owner_or_service", maximum_request_bytes: 0, response_mode: "json" },
