export interface RouteDefinition {
  ...
  readonly auth: "owner" | "service" | "owner_or_service";
  readonly maximum_request_bytes: number;
  readonly response_mode: "json" | "stream" | "handle";
}

export const ROUTES: readonly RouteDefinition[] = [
  { method: "GET", path: "/healthz", operation: "system.health.public", auth: "owner_or_service", maximum_request_bytes: 0, response_mode: "json" },
